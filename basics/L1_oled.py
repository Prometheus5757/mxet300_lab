...
def getVoltage():
    ...
    ##########################################
    return myBatt # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Phoenix", font=font, fill=255)
    ...
    #################################################
    batt_volt = getVoltage()
    volt_str = "Robot Voltage: %.2fV" % batt_volt
    draw.text((0, 40), volt_str, font=font, fill=255)
